...
--
-- Host: 127.0.0.1
-- Generation Time: May 18, 2018 at 08:51 AM
...
(170, 'Hydrochloric acid', 'SD Fine', '2.5 lts', '45', '89', '3110'),
...
INSERT INTO `msds` (`id`, `name`, `formula`, `first_aid_measures`, `precautions`, `storage`, `boiling_point`, `melting_point`, `special_remarks_on_reactivity`) VALUES
(5, '1-NAPHTHALDEHYDE', ' ', '  ', '  ', ' ', 0, 0, ' '),
(1, '1 - Naphthol', ' ', ' ', ' ', ' ', 0, 0, ' '),
(2, '1,10 - Phenanthroline', ' ', ' ', ' ', ' ', 0, 0, ' '),
(3, '1,4-DIOXANE FOR HPLC', ' ', ' ', ' ', ' ', 0, 0, ' '),
(4, '1-ACETYLNAPHTHALENE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(6, '1-NAPHTHOIC ACID', ' ', ' ', ' ', ' ', 0, 0, ' '),
(7, '1-Propanol', ' ', ' ', ' ', ' ', 0, 0, ' '),
(8, '2,2\'- Bipyridine', ' ', ' ', ' ', ' ', 0, 0, ' '),
(9, '2,4 Dinitro Phenyle hydrazine', ' ', ' ', ' ', ' ', 0, 0, ' '),
(10, '2,4-DICHLOROBENZOIC ACID', ' ', ' ', ' ', ' ', 0, 0, ' '),
(11, '2,4-DINITROCHLOROBENZENE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(12, '2,4-DINITROPHENYL HYDRAZINE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(13, '2-Aminophenol', ' ', ' ', ' ', ' ', 0, 0, ' '),
(14, '2-CHLOROPHENOL', ' ', ' ', ' ', ' ', 0, 0, ' '),
(15, '2-FUROIC ACID', ' ', ' ', ' ', ' ', 0, 0, ' '),
(16, '2-Hydroxy benzaldehyde', ' ', ' ', ' ', ' ', 0, 0, ' '),
(17, '2-HYDROXY BENZALDEHYDE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(18, '2-Hydroxybenzoic acid (Salicylic acid)', ' ', ' ', ' ', ' ', 0, 0, ' '),
(19, '2-METHOXYBENZOIC ACID', ' ', ' ', ' ', ' ', 0, 0, ' '),
(20, '2-NAPHTHOL', ' ', ' ', ' ', ' ', 0, 0, ' '),
(21, '2-PROPANOL', ' ', ' ', ' ', ' ', 0, 0, ' '),
(22, '3,5-DINITROBENZOIC ACID AR', ' ', ' ', ' ', ' ', 0, 0, ' '),
(23, '4-(Dimethylamino)cinnamaldehyde', ' ', ' ', ' ', ' ', 0, 0, ' '),
(24, '4-AMINOBENZOIC ACID', ' ', ' ', ' ', ' ', 0, 0, ' '),
(25, '4-Aminophenol ', ' ', ' ', ' ', ' ', 0, 0, ' '),
(26, '4-NITROCINNAMIC ACID', ' ', ' ', ' ', ' ', 0, 0, ' '),
(27, '4-Nitrophenol, 99 %', ' ', ' ', ' ', ' ', 0, 0, ' '),
(28, '4-NITROTOLUENE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(29, '4-PHENYLBUTYRIC ACID', ' ', ' ', ' ', ' ', 0, 0, ' '),
(30, '6-BROMO-2-NAPHTHOIC ACID', ' ', ' ', ' ', ' ', 0, 0, ' '),
(31, '8-Hydoxyquinoline', ' ', ' ', ' ', ' ', 0, 0, ' '),
(32, 'ACETALDEHYDE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(33, 'Acetic acid', ' ', ' ', ' ', ' ', 0, 0, ' '),
(34, 'Acetic Acid, 99 %, Glacial ', ' ', ' ', ' ', ' ', 0, 0, ' '),
(35, 'ACETIC ANHYDRIDE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(36, 'Acetone', ' ', ' ', ' ', ' ', 0, 0, ' '),
(37, 'ACETONE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(38, 'Acetone, 99 %, ', ' ', ' ', ' ', ' ', 0, 0, ' '),
(39, 'Acetonitrile', ' ', ' ', ' ', ' ', 0, 0, ' '),
(40, 'ACETONITRILE HPLC', ' ', ' ', ' ', ' ', 0, 0, ' '),
(41, 'Acetonitrile HPLC Grade', ' ', ' ', ' ', ' ', 0, 0, ' '),
(42, 'ACETOPHENONE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(43, 'ACETYL CHLORIDE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(44, 'Aluminium Potassium Sulfate dodecahydrate', ' ', ' ', ' ', ' ', 0, 0, ' '),
(45, 'ALUMINIUM SULPHATE, AR', ' ', ' ', ' ', ' ', 0, 0, ' '),
(46, 'ALUMINUM HYDROXIDE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(47, 'Aluminum Oxide,  Basic', ' ', ' ', ' ', ' ', 0, 0, ' '),
(48, 'Aluminum Oxide,  Neutral', ' ', ' ', ' ', ' ', 0, 0, ' '),
(49, 'Amberlite IR 120H', ' ', ' ', ' ', ' ', 0, 0, ' '),
(50, 'Amberlite IRA-404 Cl', ' ', ' ', ' ', ' ', 0, 0, ' '),
(51, 'Ammonia 25 % Aq. solution', ' ', ' ', ' ', ' ', 0, 0, ' '),
(52, 'Ammonia Solution', ' ', ' ', ' ', ' ', 0, 0, ' '),
(53, 'Ammonium Chloride', ' ', ' ', ' ', ' ', 0, 0, ' '),
(54, 'AMMONIUM CHLORIDE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(55, 'Ammonium Chloride', ' ', ' ', ' ', ' ', 0, 0, ' '),
(56, 'Ammonium Ferric Sulphate, AR', ' ', ' ', ' ', ' ', 0, 0, ' '),
(57, 'Ammonium Ferrous sulfate hexahydrate, AR', ' ', ' ', ' ', ' ', 0, 0, ' '),
(58, 'Ammonium Hydroxide 25%', ' ', ' ', ' ', ' ', 0, 0, ' '),
(59, 'AMMONIUM MOLYBDATE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(60, 'Ammonium Molybdate tetrahydrate, 98 %', ' ', ' ', ' ', ' ', 0, 0, ' '),
(61, 'Ammonium Nickel sulfate hexahydrate', ' ', ' ', ' ', ' ', 0, 0, ' '),
(62, 'Ammonium Oxalate Monohydrate, 98 %', ' ', ' ', ' ', ' ', 0, 0, ' '),
(63, 'Ammonium Thicyanate, 98 %', ' ', ' ', ' ', ' ', 0, 0, ' '),
(64, 'Aniline', ' ', ' ', ' ', ' ', 0, 0, ' '),
(65, 'ANTHRACENE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(66, 'APCI Tuning mix', ' ', ' ', ' ', ' ', 0, 0, ' '),
(67, 'Barium chloride dihydrate', ' ', ' ', ' ', ' ', 0, 0, ' '),
(68, 'Barium nitrate', ' ', ' ', ' ', ' ', 0, 0, ' '),
(69, 'BENEDICT\'S REAGENT', ' ', ' ', ' ', ' ', 0, 0, ' '),
(70, 'Benzaldehyde', ' ', ' ', ' ', ' ', 0, 0, ' '),
(71, 'BENZAMIDE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(72, 'BENZENESULFONYL CHLORIDE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(73, 'BENZIL', ' ', ' ', ' ', ' ', 0, 0, ' '),
(74, 'BENZOPHENONE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(75, 'Beta-cyclodextrin', ' ', ' ', ' ', ' ', 0, 0, ' '),
(76, 'BIS(2-METHOXYETHYL)ETHER OR DIGLYME', ' ', ' ', ' ', ' ', 0, 0, ' '),
(77, 'BLEACHING POWDER', ' ', ' ', ' ', ' ', 0, 0, ' '),
(78, 'Buffer pH-4', ' ', ' ', ' ', ' ', 0, 0, ' '),
(79, 'Buffer tablets pH 4', ' ', ' ', ' ', ' ', 0, 0, ' '),
(80, 'Buffer tablets pH 7.0', ' ', ' ', ' ', ' ', 0, 0, ' '),
(81, 'Buffer tablets pH 9.2', ' ', ' ', ' ', ' ', 0, 0, ' '),
(82, 'Calcium Carbonate', ' ', ' ', ' ', ' ', 0, 0, ' '),
(83, 'Calcium Carbonate, 98 %', ' ', ' ', ' ', ' ', 0, 0, ' '),
(84, 'Calcium Chloride', ' ', ' ', ' ', ' ', 0, 0, ' '),
(85, 'Calcium Chloride dihydrate', ' ', ' ', ' ', ' ', 0, 0, ' '),
(86, 'Calcium Fluoride 98 %', ' ', ' ', ' ', ' ', 0, 0, ' '),
(87, 'CALCIUM SULPHATE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(88, 'CARBON DISULFIDE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(89, 'CARBON TETRACHLORIDE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(90, 'Catechol', ' ', ' ', ' ', ' ', 0, 0, ' '),
(91, 'CERRIC AMMONIUM NITRATE ', ' ', ' ', ' ', ' ', 0, 0, ' '),
(92, 'Chitin, purified flakes', ' ', ' ', ' ', ' ', 0, 0, ' '),
(93, 'CHLORINETEST REAGENT', ' ', ' ', ' ', ' ', 0, 0, ' '),
(94, 'Chloroauric Acid', ' ', ' ', ' ', ' ', 0, 0, ' '),
(95, 'Chloroform, 98 %', ' ', ' ', ' ', ' ', 0, 0, ' '),
(96, 'CHLOROFORM, HPLC', ' ', ' ', ' ', ' ', 0, 0, ' '),
(97, 'Chloroform-D + 0.3% TMS', ' ', ' ', ' ', ' ', 0, 0, ' '),
(98, 'Chloroform-D + 0.3% TMS', ' ', ' ', ' ', ' ', 0, 0, ' '),
(99, 'Citric acid', ' ', ' ', ' ', ' ', 0, 0, ' '),
(100, 'Cobalt (II) chloride hexahydrate', ' ', ' ', ' ', ' ', 0, 0, ' '),
(101, 'Cobalt (II) sulfate 7-hydrate', ' ', ' ', ' ', ' ', 0, 0, ' '),
(102, 'COBALT NITRATE (Hexahydrate)', ' ', ' ', ' ', ' ', 0, 0, ' '),
(103, 'Copper acetate (Cu(OAc)2.H2O)', ' ', ' ', ' ', ' ', 0, 0, ' '),
(104, 'Copper Sulphate', ' ', ' ', ' ', ' ', 0, 0, ' '),
(105, 'Copper(II) nitrate trihydrate, 98 %', ' ', ' ', ' ', ' ', 0, 0, ' '),
(106, 'Copper(II) sulfate pentahydrate, 98 %', ' ', ' ', ' ', ' ', 0, 0, ' '),
(107, 'Copper(II) sulfate pentahydrate, 98 %', ' ', ' ', ' ', ' ', 0, 0, ' '),
(108, 'CTAB', ' ', ' ', ' ', ' ', 0, 0, ' '),
(109, 'CYCLOHEXANONE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(110, 'CYCLOHEXANONE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(111, 'Dextrose (D-Glucose)', ' ', ' ', ' ', ' ', 0, 0, ' '),
(112, 'D-Galactose', ' ', ' ', ' ', ' ', 0, 0, ' '),
(113, 'D-GLUCOSE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(114, 'Dichloromethane', ' ', ' ', ' ', ' ', 0, 0, ' '),
(115, 'DICHLOROMETHANE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(116, 'Dichloromethane (HPLC)', ' ', ' ', ' ', ' ', 0, 0, ' '),
(117, 'Diethyl ether', ' ', ' ', ' ', ' ', 0, 0, ' '),
(118, 'DIETHYL ETHER', ' ', ' ', ' ', ' ', 0, 0, ' '),
(119, 'DIETHYL KETONE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(120, 'DIETHYLAMINE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(121, 'Dimethyl Sulphoxide-d6', ' ', ' ', ' ', ' ', 0, 0, ' '),
(122, 'Dimethyl Sulphoxide-d6 5X10ML', ' ', ' ', ' ', ' ', 0, 0, ' '),
(123, 'Dimethylglyoxime', ' ', ' ', ' ', ' ', 0, 0, ' '),
(124, 'DIOCTYL SULFOSUCCINATE SODIUM SALT', ' ', ' ', ' ', ' ', 0, 0, ' '),
(125, 'DIPHENYLAMINE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(126, 'DL-TARTARIC ACID', ' ', ' ', ' ', ' ', 0, 0, ' '),
(127, 'Dodecanethiol', ' ', ' ', ' ', ' ', 0, 0, ' '),
(128, 'D-Ribose', ' ', ' ', ' ', ' ', 0, 0, ' '),
(129, 'EBT', ' ', ' ', ' ', ' ', 0, 0, ' '),
(130, 'EDTA di sodium salt', ' ', ' ', ' ', ' ', 0, 0, ' '),
(131, 'EDTA disodium salt dihydrate, 98 %', ' ', ' ', ' ', ' ', 0, 0, ' '),
(132, 'ERICHROME BLACK T ', ' ', ' ', ' ', ' ', 0, 0, ' '),
(133, 'Ethanol', ' ', ' ', ' ', ' ', 0, 0, ' '),
(136, 'ETHYL 4-NITROBENZOATE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(137, 'Ethyl Acetate', ' ', ' ', ' ', ' ', 0, 0, ' '),
(138, 'ETHYL ACETOACETATE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(139, 'ETHYL ACETOACETATE, 98%', ' ', ' ', ' ', ' ', 0, 0, ' '),
(140, 'Ethyl Benzoate', ' ', ' ', ' ', ' ', 0, 0, ' '),
(141, 'ETHYL P-HYDROXYBENZOATE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(142, 'Ethylacetate', ' ', ' ', ' ', ' ', 0, 0, ' '),
(143, 'ETHYLBENZOATE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(144, 'ETHYLENE GLYCOL', ' ', ' ', ' ', ' ', 0, 0, ' '),
(145, 'Ethylenediamine', ' ', ' ', ' ', ' ', 0, 0, ' '),
(146, 'Ethylenediammine, 98 %', ' ', ' ', ' ', ' ', 0, 0, ' '),
(147, 'Fehling A', ' ', ' ', ' ', ' ', 0, 0, ' '),
(148, 'Fehling B', ' ', ' ', ' ', ' ', 0, 0, ' '),
(149, 'FEHLING SOLUTION A', ' ', ' ', ' ', ' ', 0, 0, ' '),
(150, 'FEHLING SOLUTION B', ' ', ' ', ' ', ' ', 0, 0, ' '),
(151, 'FERRIC CHLORIDE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(152, 'Ferric nitrate', ' ', ' ', ' ', ' ', 0, 0, ' '),
(153, 'Ferric sulphate', ' ', ' ', ' ', ' ', 0, 0, ' '),
(154, 'FERRIC SULPHATE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(155, 'Ferrous Sulfide Sticks,  pyrite', ' ', ' ', ' ', ' ', 0, 0, ' '),
(156, 'FERROUS SULPHATE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(157, 'Ferrous sulphate', ' ', ' ', ' ', ' ', 0, 0, ' '),
(158, 'Formic Acid', ' ', ' ', ' ', ' ', 0, 0, ' '),
(159, 'FORMIC ACID 98%', ' ', ' ', ' ', ' ', 0, 0, ' '),
(160, 'Fructose', ' ', ' ', ' ', ' ', 0, 0, ' '),
(161, 'FUMARIC ACID', ' ', ' ', ' ', ' ', 0, 0, ' '),
(162, 'FURFURALALDEHYDE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(163, 'Gelatin', ' ', ' ', ' ', ' ', 0, 0, ' '),
(164, 'Glucose', ' ', ' ', ' ', ' ', 0, 0, ' '),
(165, 'Glycerol,AR', ' ', ' ', ' ', ' ', 0, 0, ' '),
(166, 'GLYCINE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(167, 'Gold Chloride trihydrate (HAuCl4, 3H2O)', ' ', ' ', ' ', ' ', 0, 0, ' '),
(168, 'GUAIACOL (2-METHOXYPHENOL)', ' ', ' ', ' ', ' ', 0, 0, ' '),
(169, 'Hexamethylenetetraamine', ' ', ' ', ' ', ' ', 0, 0, ' '),
(170, 'Hexane', ' ', ' ', ' ', ' ', 0, 0, ' '),
(171, 'HEXANE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(172, 'Hydrochloric acid', ' ', ' ', ' ', ' ', 0, 0, ' '),
(173, 'HYDROCHLORIC ACID (AR)', ' ', ' ', ' ', ' ', 0, 0, ' '),
(174, 'Hydrogen peroxide 30%', ' ', ' ', ' ', ' ', 0, 0, ' '),
(175, 'Hydroquinone', ' ', ' ', ' ', ' ', 0, 0, ' '),
(176, 'Iodine', ' ', ' ', ' ', ' ', 0, 0, ' '),
(177, 'Iron (III) Chloride, Anhydrous', ' ', ' ', ' ', ' ', 0, 0, ' '),
(178, 'Iron(II) Sulfate heptahydrate, 95%', ' ', ' ', ' ', ' ', 0, 0, ' '),
(179, 'Iron(II) Sulfate heptahydrate, 95%', ' ', ' ', ' ', ' ', 0, 0, ' '),
(180, 'Iron(III) sulfate hydrate', ' ', ' ', ' ', ' ', 0, 0, ' '),
(181, 'iso-AMYL ALCOHOL', ' ', ' ', ' ', ' ', 0, 0, ' '),
(182, 'Isopropyl alcohol', ' ', ' ', ' ', ' ', 0, 0, ' '),
(183, 'L-Ascorbic Acid', ' ', ' ', ' ', ' ', 0, 0, ' '),
(184, 'LEAD ACETATE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(185, 'L-GLUTAMINE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(186, 'L-GLYCINE ', ' ', ' ', ' ', ' ', 0, 0, ' '),
(187, 'L-Histidine', ' ', ' ', ' ', ' ', 0, 0, ' '),
(188, 'L-PHENYL ALANINE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(189, 'L-Tryptophan', ' ', ' ', ' ', ' ', 0, 0, ' '),
(190, 'L-Tyrosine', ' ', ' ', ' ', ' ', 0, 0, ' '),
(191, 'Luminol', ' ', ' ', ' ', ' ', 0, 0, ' '),
(192, 'L-Valine', ' ', ' ', ' ', ' ', 0, 0, ' '),
(193, 'Magnesium nitrate hexahydrate', ' ', ' ', ' ', ' ', 0, 0, ' '),
(194, 'MALEIC ANHYDRIDE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(195, 'Manganese(II) Chloride tetrahydrate, 98 %', ' ', ' ', ' ', ' ', 0, 0, ' '),
(196, 'm-BROMOBENZOIC ACID', ' ', ' ', ' ', ' ', 0, 0, ' '),
(197, 'm-CHLOROBENZOIC ACID', ' ', ' ', ' ', ' ', 0, 0, ' '),
(198, 'Mercury (II) Chloride', ' ', ' ', ' ', ' ', 0, 0, ' '),
(199, 'Methanol', ' ', ' ', ' ', ' ', 0, 0, ' '),
(200, 'METHANOL', ' ', ' ', ' ', ' ', 0, 0, ' '),
(201, 'Methanol', ' ', ' ', ' ', ' ', 0, 0, ' '),
(202, 'METHANOL FOR UV SPECTROSCOPY', ' ', ' ', ' ', ' ', 0, 0, ' '),
(203, 'METHANOL HPLC GRADE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(204, 'METHYL BENZOATE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(205, 'Methyl red sodium salt', ' ', ' ', ' ', ' ', 0, 0, ' '),
(206, 'METHYL SALICYLATE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(207, 'm-NITROBENZALDEHYDE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(208, 'm-NITROBENZOIC ACID', ' ', ' ', ' ', ' ', 0, 0, ' '),
(209, 'm-TOLUIC ACID', ' ', ' ', ' ', ' ', 0, 0, ' '),
(210, 'm-TOLUIDINE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(211, 'Murexide', ' ', ' ', ' ', ' ', 0, 0, ' '),
(212, 'N,N-DIMETHYL FORMAMIDE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(213, 'NAPHTHALENE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(214, 'n-BUTYL ALCOHOL', ' ', ' ', ' ', ' ', 0, 0, ' '),
(215, 'NESSLER REAGENT', ' ', ' ', ' ', ' ', 0, 0, ' '),
(216, 'N-HEXANE FOR UV SPECTROSCOPY', ' ', ' ', ' ', ' ', 0, 0, ' '),
(217, 'N-HEXANE HPLC GRADE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(218, 'NICKEL CHLORIDE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(219, 'Nickel sulfate ', ' ', ' ', ' ', ' ', 0, 0, ' '),
(220, 'Nickel(II) Chloride hexahydrate, 98 %', ' ', ' ', ' ', ' ', 0, 0, ' '),
(221, 'NINHYDRIN', ' ', ' ', ' ', ' ', 0, 0, ' '),
(222, 'NITRIC ACID', ' ', ' ', ' ', ' ', 0, 0, ' '),
(223, 'NITROBENZENE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(224, 'o-AMINOACETOPHENONE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(225, 'o-CRESOL', ' ', ' ', ' ', ' ', 0, 0, ' '),
(226, 'Oil for saponification experiment', ' ', ' ', ' ', ' ', 0, 0, ' '),
(227, 'o-IODOBENZOIC ACID', ' ', ' ', ' ', ' ', 0, 0, ' '),
(228, 'o-PHENYL DIAMINE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(229, 'Orthophosphoric Acid, 86 %', ' ', ' ', ' ', ' ', 0, 0, ' '),
(230, 'Oxalic acid', ' ', ' ', ' ', ' ', 0, 0, ' '),
(231, 'Oxalic Acid Dihydrate, AR', ' ', ' ', ' ', ' ', 0, 0, ' '),
(232, 'p-ANISALDEHYDE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(233, 'PARAFFIN OIL LIGHT', ' ', ' ', ' ', ' ', 0, 0, ' '),
(234, 'p-BROMOANILINE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(235, 'p-CHLOROANILINE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(236, 'p-CHLOROBENZALDEHYDE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(237, 'p-CHLOROBENZOIC ACID', ' ', ' ', ' ', ' ', 0, 0, ' '),
(238, 'p-CRESOL', ' ', ' ', ' ', ' ', 0, 0, ' '),
(239, 'PHENOL', ' ', ' ', ' ', ' ', 0, 0, ' '),
(240, 'Phenolphthalein', ' ', ' ', ' ', ' ', 0, 0, ' '),
(241, 'Phenolphthalein indicator', ' ', ' ', ' ', ' ', 0, 0, ' '),
(242, 'PHENYL HYDRAZINE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(243, 'PHTHALIC ANHYDRIDE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(244, 'p-HYDROXYACETOPHENONE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(245, 'p-HYDROXYBENZALDEHYDE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(246, 'PIPERIDINE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(247, 'p-NITROBENZALDEHYDE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(248, 'p-NITROBENZOIC ACID', ' ', ' ', ' ', ' ', 0, 0, ' '),
(249, 'p-NITROBENZYL ALCOHOL', ' ', ' ', ' ', ' ', 0, 0, ' '),
(250, 'p-NITROPHTHALIC ACID', ' ', ' ', ' ', ' ', 0, 0, ' '),
(251, 'Polyvinylpyrrolidone pure ', ' ', ' ', ' ', ' ', 0, 0, ' '),
(252, 'Potassium Acetate, 98 %', ' ', ' ', ' ', ' ', 0, 0, ' '),
(253, 'POTASSIUM BROMIDE FOR IR', ' ', ' ', ' ', ' ', 0, 0, ' '),
(254, 'Potassium Bromide, 99 %', ' ', ' ', ' ', ' ', 0, 0, ' '),
(255, 'Potassium Carbonate, 98 %', ' ', ' ', ' ', ' ', 0, 0, ' '),
(256, 'Potassium Chloride', ' ', ' ', ' ', ' ', 0, 0, ' '),
(257, 'Potassium chloride', ' ', ' ', ' ', ' ', 0, 0, ' '),
(258, 'POTASSIUM DICHROMATE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(259, 'Potassium dichromate, AR', ' ', ' ', ' ', ' ', 0, 0, ' '),
(260, 'Potassium dihydrogen phosphate', ' ', ' ', ' ', ' ', 0, 0, ' '),
(261, 'Potassium ferricyanide, LR', ' ', ' ', ' ', ' ', 0, 0, ' '),
(262, 'POTASSIUM FERROCYANIDE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(263, 'Potassium ferrocyanide trihydrate, AR', ' ', ' ', ' ', ' ', 0, 0, ' '),
(264, 'Potassium Fluoride', ' ', ' ', ' ', ' ', 0, 0, ' '),
(265, 'Potassium Hexacyanoferrate K3Fe(CN)6', ' ', ' ', ' ', ' ', 0, 0, ' '),
(266, 'Potassium hydroxide', ' ', ' ', ' ', ' ', 0, 0, ' '),
(267, 'POTASSIUM HYDROXIDE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(268, 'POTASSIUM IODATE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(269, 'Potassium Iodide', ' ', ' ', ' ', ' ', 0, 0, ' '),
(270, 'Potassium Oxalate', ' ', ' ', ' ', ' ', 0, 0, ' '),
(271, 'POTASSIUM PERMANGANATE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(272, 'Potassium phosphate dibasic', ' ', ' ', ' ', ' ', 0, 0, ' '),
(273, 'Potassium sulphate, 99 %', ' ', ' ', ' ', ' ', 0, 0, ' '),
(274, 'Potassium Thiocyanate', ' ', ' ', ' ', ' ', 0, 0, ' '),
(275, 'PROPAN-2-OL', ' ', ' ', ' ', ' ', 0, 0, ' '),
(276, 'PYRIDINE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(277, 'QUININE SULPHATE dihydrate', ' ', ' ', ' ', ' ', 0, 0, ' '),
(278, 'Resorcinol', ' ', ' ', ' ', ' ', 0, 0, ' '),
(279, 'Riboflavin', ' ', ' ', ' ', ' ', 0, 0, ' '),
(280, 'SALICYLALDEHYDE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(281, 'SCHIFF\'S REAGENT', ' ', ' ', ' ', ' ', 0, 0, ' '),
(282, 'SILICA GEL', ' ', ' ', ' ', ' ', 0, 0, ' '),
(283, 'SILICONE GREASE HIGH VACUUM', ' ', ' ', ' ', ' ', 0, 0, ' '),
(284, 'Silicone oil', ' ', ' ', ' ', ' ', 0, 0, ' '),
(285, 'Silver nitrate', ' ', ' ', ' ', ' ', 0, 0, ' '),
(286, 'SODIUM ACETATE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(287, 'Sodium bis (2-ethylhexyl) sulfosuccinate', ' ', ' ', ' ', ' ', 0, 0, ' '),
(288, 'SODIUM BISULPHITE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(289, 'SODIUM BOROHYDRIDE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(290, 'Sodium Carbonate', ' ', ' ', ' ', ' ', 0, 0, ' '),
(291, 'SODIUM CARBONATE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(292, 'Sodium carbonate monohydrate', ' ', ' ', ' ', ' ', 0, 0, ' '),
(293, 'Sodium Chloride, AR', ' ', ' ', ' ', ' ', 0, 0, ' '),
(294, 'Sodium citrate dihydrate, 99 % ', ' ', ' ', ' ', ' ', 0, 0, ' '),
(295, 'Sodium diphenylamine sulfonate', ' ', ' ', ' ', ' ', 0, 0, ' '),
(296, 'Sodium Dodecylsulphate (SDS)', ' ', ' ', ' ', ' ', 0, 0, ' '),
(297, 'Sodium hydrogen Carbonate', ' ', ' ', ' ', ' ', 0, 0, ' '),
(298, 'Sodium Hydroxide', ' ', ' ', ' ', ' ', 0, 0, ' '),
(299, 'SODIUM HYDROXIDE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(300, 'SODIUM METAL', ' ', ' ', ' ', ' ', 0, 0, ' '),
(301, 'Sodium Nitrate, 99 %', ' ', ' ', ' ', ' ', 0, 0, ' '),
(302, 'SODIUM NITRITE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(303, 'Sodium sulfate anhydrous', ' ', ' ', ' ', ' ', 0, 0, ' '),
(304, 'SODIUM SULPHATE, ANHYD', ' ', ' ', ' ', ' ', 0, 0, ' '),
(305, 'Sodium Thiosulfate pentahydrate', ' ', ' ', ' ', ' ', 0, 0, ' '),
(306, 'Sodium thiosulphate', ' ', ' ', ' ', ' ', 0, 0, ' '),
(307, 'Sodium Tungstate dihydrate', ' ', ' ', ' ', ' ', 0, 0, ' '),
(308, 'Starch', ' ', ' ', ' ', ' ', 0, 0, ' '),
(309, 'Starch soluble AR', ' ', ' ', ' ', ' ', 0, 0, ' '),
(310, 'Succinic acid', ' ', ' ', ' ', ' ', 0, 0, ' '),
(311, 'Sucrose', ' ', ' ', ' ', ' ', 0, 0, ' '),
(312, 'Sulphuric acid', ' ', ' ', ' ', ' ', 0, 0, ' '),
(313, 'SULPHURIC ACID', ' ', ' ', ' ', ' ', 0, 0, ' '),
(314, 'Tartaric acid', ' ', ' ', ' ', ' ', 0, 0, ' '),
(315, 'TERT-BUTYL METHYL ETHER', ' ', ' ', ' ', ' ', 0, 0, ' '),
(316, 'Tetrabutylammonium bromide, 98 %', ' ', ' ', ' ', ' ', 0, 0, ' '),
(317, 'Tetraoctylaammonium bromide', ' ', ' ', ' ', ' ', 0, 0, ' '),
(318, 'THIAMINE HYDROCHLORIDE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(319, 'THIN LAYER CHROMATOGRAPHY PLATES', ' ', ' ', ' ', ' ', 0, 0, ' '),
(320, 'THIOUREA', ' ', ' ', ' ', ' ', 0, 0, ' '),
(321, 'Tin (II) Chloride', ' ', ' ', ' ', ' ', 0, 0, ' '),
(322, 'TIN METAL GRANULATED', ' ', ' ', ' ', ' ', 0, 0, ' '),
(323, 'TOLUENE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(324, 'Toluene, 99 %', ' ', ' ', ' ', ' ', 0, 0, ' '),
(325, 'TRANS-CINNAMIC ACID', ' ', ' ', ' ', ' ', 0, 0, ' '),
(326, 'TRIETHYL AMINE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(327, 'Urea, AR', ' ', ' ', ' ', ' ', 0, 0, ' '),
(328, 'VANILLIC ACID', ' ', ' ', ' ', ' ', 0, 0, ' '),
(329, 'Vitamin C (tablets)', ' ', ' ', ' ', ' ', 0, 0, ' '),
(330, 'Water', ' ', ' ', ' ', ' ', 0, 0, ' '),
(331, 'Water for HPLC', ' ', ' ', ' ', ' ', 0, 0, ' '),
(332, 'XYLENE (SULPHUR FREE)', ' ', ' ', ' ', ' ', 0, 0, ' '),
(333, 'Zinc Acetate', ' ', ' ', ' ', ' ', 0, 0, ' '),
(334, 'ZINC CHLORIDE', ' ', ' ', ' ', ' ', 0, 0, ' '),
(335, 'ZINC METAL dust', ' ', ' ', ' ', ' ', 0, 0, ' '),
(336, 'Zinc nitrate', ' ', ' ', ' ', ' ', 0, 0, ' '),
(337, 'Zinc Sulfate heptahydrate', ' ', ' ', ' ', ' ', 0, 0, ' ');
